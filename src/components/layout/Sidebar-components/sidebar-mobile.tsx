                              ...
                              {item.children.map((child, ci) => {
                                if (isSubGroup(child)) {
                                  ...
                                  return (
                                    <div key={child.name}>
                                      <button
                                        onClick={() => toggleGroup(`${item.name}__${child.name}`)}
                                      ...
                                      >
                                        ...
                                        <span className="flex-1 text-left whitespace-nowrap">{child.name}</span>
                                            ...
                                            <div className="ml-3 pl-3 border-l border-outline-variant/20 mt-0.5 space-y-0.5 pb-1">
                                              {child.children.map((leaf) => {
                                                ...
                                                return (
                                                  ...
                                                  >
                                                    {active && <motion.div layoutId={`activeMobileLeaf-${leaf.path}`} className="absolute inset-0 bg-brand-500/[0.08] rounded-xl" transition={{ type: "spring", stiffness: 320, damping: 30 }} />}
