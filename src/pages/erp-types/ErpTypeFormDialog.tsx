...
interface ErpTypeFormDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: CreateErpTypeDto | UpdateErpTypeDto) => void;
  erpType?: ErpType | null;
  loading: boolean;
}

export default function ErpTypeFormDialog({
  isOpen,
  onClose,
  onSubmit,
  erpType,
  loading,
}: ErpTypeFormDialogProps) {
      ...
      <div className="form-dialog-content max-w-md">
        ...
        <div className="flex items-center justify-between p-6">
          <h2 className="text-xl font-semibold text-on-surface">
            {erpType ? 'Edit Service Type' : 'Create Service Type'}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Enter ERP type name (e.g., Installation)"
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? 'Saving...' : erpType ? 'Update' : 'Create'}
            </Button>
          </div>
        </form>
      </div>
