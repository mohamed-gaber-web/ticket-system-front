  ...
  if (erpTypes.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 text-lg">No ERP types found</p>
        <p className="text-gray-500 text-sm mt-2">Create your first ERP type to get started</p>
      </div>
    );
  }
        ...
        <Table>
          ...
          <TableBody>
            {erpTypes.map((erpType) => (
              <TableRow key={erpType._id} className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium text-gray-900">{erpType.name}</TableCell>
                <TableCell>
                  <span
