...
export default function Modules() {
  ...
  const { modules, loading, total, pages } = useAppSelector((state) => state.modules);
  ...
  const handleRefresh = () => {
    ...
    setStatusFilter('');
    setCurrentPage(1);
    dispatch(fetchModules({ page: 1, limit: PAGE_LIMIT }));
  };
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="bg-surface-container-lowest rounded-[1rem] p-4">
        ...
        <div className="mt-4 text-sm text-on-surface-variant">
          ...
          <span className="font-semibold text-on-surface">{total}</span> modules
        </div>
      </div>
