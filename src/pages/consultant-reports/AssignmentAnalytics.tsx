    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-gray-900">Assignment Analytics</h1>
                ...
                {stats.byConsultant.slice(0, 10).map((consultant) => {
                  ...
                  return (
                    <tr key={consultant._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-600">{consultant.count}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{acceptanceRate}%</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                ...
                {stats.byTeam.map((team) => {
                  ...
                  return (
                    <tr key={team._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-600">{team.count}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-sm font-medium text-gray-600 uppercase">Pending Acceptance</p>
