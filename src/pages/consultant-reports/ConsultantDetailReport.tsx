      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          <CardContent className="p-6">
            ...
            <h3 className="text-3xl font-bold text-blue-600 mt-2">{assignments.length}</h3>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            <p className="text-sm font-medium text-gray-600 uppercase">Current Active</p>
            <h3 className="text-3xl font-bold text-purple-600 mt-2">{currentAssignments.length}</h3>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
