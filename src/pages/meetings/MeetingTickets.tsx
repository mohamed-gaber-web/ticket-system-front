...
export default function MeetingTickets() {
  ...
  // Resolve meeting category IDs from loaded list
  ...
  const fetchPage = useCallback((p: number) => {
    if (!meetingCategoryIds.length) return;
    dispatch(fetchTickets({ category: meetingCategoryIds.join(','), page: p, limit: PAGE_SIZE }));
  }, [dispatch, meetingCategoryIds.join(',')]);
