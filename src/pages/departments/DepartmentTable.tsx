  ...
  if (departments.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-on-surface-variant text-lg">No departments found</p>
        <p className="text-on-surface-variant text-sm mt-2">Create your first department to get started</p>
      </div>
    );
  }
        ...
        <Table>
          ...
          <TableBody>
            {departments.map((department) => (
              <TableRow key={department._id} className="hover:bg-surface-container-low transition-colors">
                <TableCell className="font-medium text-on-surface">{department.name}</TableCell>
                <TableCell>
                  <span
