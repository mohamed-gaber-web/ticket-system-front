...
export default function Environments() {
  ...
  const { environments, loading, total, pages } = useAppSelector((state) => state.environments);
  ...
  const handleRefresh = () => {
    ...
    setStatusFilter('');
    setCurrentPage(1);
    dispatch(fetchEnvironments({ page: 1, limit: PAGE_LIMIT }));
  };
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="bg-surface-container-lowest rounded-[1rem] p-4">
        ...
        <div className="mt-4 text-sm text-on-surface-variant">
          ...
          <span className="font-semibold text-on-surface">{total}</span> environments
        </div>
      </div>
