  ...
  if (scopes.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 text-lg">No scopes found</p>
        <p className="text-gray-500 text-sm mt-2">Create your first scope to get started</p>
      </div>
    );
  }
    ...
    <div className="rounded-lg border bg-white shadow-sm overflow-hidden">
      <div className="overflow-x-auto">
        <Table>
          ...
          <TableBody>
            {scopes.map((scope) => (
              <TableRow key={scope._id} className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium text-gray-900">{scope.name}</TableCell>
                <TableCell>
                  <span
