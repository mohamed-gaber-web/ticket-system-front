...
const ProfilePage = () => {
  ...
  // Employees outside the ticketing module get the plain profile — no ticket
  // stats, no assignments list.
  const isTasksDeptConsultant = isConsultant && !access.hasModule('tickets');
